...
pre_prompt = "Options: "
post_prompt = ". Select from the above options only. Do not return an answer that is not listed in the options."
...
q = ["Summarize the abstract for a high school student", \
     "Classify the abstract into one of the following publication types: \
     Original Research, Review, Other, NA/TBD. \
     Return the category and reason for category selection in JSON format.", \
